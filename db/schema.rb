...
ActiveRecord::Schema.define(:version => 20110613032022) do

  create_table "sina_statuses", :force => true do |t|
  ...
  create_table "sina_statusesss", :primary_key => "statusID", :force => true do |t|
  ...
  create_table "sina_users", :primary_key => "userID", :force => true do |t|
